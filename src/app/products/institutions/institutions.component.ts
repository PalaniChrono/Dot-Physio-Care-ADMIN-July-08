...
export class InstitutionsComponent implements OnInit {
  ...
  getProductSection(){
    ...
    this.header = this.productDetails.one_right_heading;
    this.content = this.productDetails.one_right_content;
    this.loading = false;
...
updateHeader(){
  const value = {
    type: "institutions",
    one_right_heading: this.header,
    one_right_content: this.content
