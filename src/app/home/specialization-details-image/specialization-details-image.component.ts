...
@Component({
  selector: 'app-specialization-details-image',
  templateUrl: './specialization-details-image.component.html',
  styleUrls: ['./specialization-details-image.component.css']
})
export class SpecializationDetailsImageComponent implements OnInit {
  ...
  imageUpdateBanner(imageFile) {
      ...
      this.apiService.postData(formData, 'imageUpdateSpecialization').subscribe(data => {
      if (data.error === false) {
          this.toastr.success(data.message);
          this.router.navigate(['/specialization-details']);
      } else {
