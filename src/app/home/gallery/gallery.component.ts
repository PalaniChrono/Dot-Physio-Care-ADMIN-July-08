...
export class GalleryComponent implements OnInit {
  ...
  index() {
      this.loading = true;
      this.apiService.index('getAllGalleryImage').subscribe(data => {
  ...
  store() {
      ...
      this.apiCall('store', 'galleryImage');
  }

  show(id) {
      this.apiService.show('galleryImage/' + id).subscribe((data) => {
  ...
  update(id) {
      this.loadingBtn = true;
      this.apiCall('update', 'galleryImage/' + id);
  }
  ...
  bannerSwitch(id) {
      this.apiCall('getData', 'galleryImageSwitch/' + id);
  }
  ...
  swalCall(id) {
      Swal.fire({
          ...
          if (result.value) {
              this.apiCall('destroy', 'galleryImage/' + id);
              Swal.fire(
                  'Deleted!',
