...
export class HomebannerComponent implements OnInit {
  ...
  index() {
      this.loading = true;
      this.apiService.index('getAllHomeBanner').subscribe(data => {
  ...
  store() {
      ...
      this.apiCall('store', 'HomeBanner');
  }

  show(id) {
      this.apiService.show('HomeBanner/' + id).subscribe((data) => {
  ...
  update(id) {
      this.loadingBtn = true;
      this.apiCall('update', 'HomeBanner/' + id);
  }
  ...
  bannerSwitch(id) {
      this.apiCall('getData', 'HomeBannerSwitch/' + id);
  }
  ...
  swalCall(id) {
      Swal.fire({
          ...
          if (result.value) {
              this.apiCall('destroy', 'HomeBanner/' + id);
              Swal.fire(
                  'Deleted!',
