...
@Component({
  selector: 'app-testimonial-imgupload',
  templateUrl: './testimonial-imgupload.component.html',
  styleUrls: ['./testimonial-imgupload.component.css']
})
export class TestimonialImguploadComponent implements OnInit {
  loadingBtn: boolean;
  imageChangedEvent: any = '';
  croppedImage: any = '';
  loading: boolean;
  public files: NgxFileDropEntry[] = [];
  menu: string = this.route.snapshot.paramMap.get('menu');
  ...
  imageUpdateSubCategory(imageFile) {
    ...
    this.apiService.postData(formData, 'updateImageById').subscribe(data => {
      if (data.error === false) {
